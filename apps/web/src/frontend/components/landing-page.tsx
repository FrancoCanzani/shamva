...
export default function LandingPage() {
  ...
  return (
    <div className="bg-background mx-auto min-h-screen max-w-5xl p-6">
      <div>
        ...
        <main className="space-y-10 py-16">
          <div className="space-y-6">
            ...
            <h2 className="text-foreground text-6xl font-medium">
              The simple monitoring platform
            </h2>
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Our distributed system continuously checks your services
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  SMS, WhatsApp, and GitHub. Email notifications are included
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ⎿ HTTP monitors (GET, POST, HEAD), TCP monitors, and
                  heartbeats. You can configure custom headers, request bodies,
                  check intervals from 1 minute to 1 hour, and set up heartbeat
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  self-host it for free or use the hosted service when pricing
                  is announced.
                </p>
              </div>
            </div>
