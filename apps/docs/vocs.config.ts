    ...
    },
    {
      ...
      items: [
        { text: "What is a Monitor?", link: "/user-guide/what-is-a-monitor" },
        {
          ...
          link: "/user-guide/creating-your-first-monitor",
        },
        {
          text: "How Monitoring Works",
          link: "/user-guide/how-monitoring-works",
        },
        {
          text: "Incidents and Downtime",
          link: "/user-guide/incidents-and-downtime",
        },
        {
          text: "Notifications and Alerts",
          link: "/user-guide/notifications-and-alerts",
        },
