    ...
    >
      ...
      >
        <div
          ...
          className="bg-background group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]: flex h-full w-full flex-col group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
